...
public:
	 ...
	 * @return true if uniform is found and set.
	 */
	static inline bool SetUniformFloat(uint32_t program, const char* name, float v)
	{
	...
	static inline bool SetUniformVec3(uint32_t program, const char* name, const glm::vec3& v)
	{
		const GLint location = glGetUniformLocation(program, name);
		if (location != -1)
		{
	...
	static inline bool SetUniformVec4(uint32_t program, const char* name, const glm::vec4& v)
	{
		const GLint location = glGetUniformLocation(program, name);
		if (location != -1)
		{
	...
	static inline bool SetUniformMatrix3(uint32_t program, const char* name, const glm::mat3& m)
	{
		const GLint location = glGetUniformLocation(program, name);
		if (location != -1)
		{
	...
	static inline bool SetUniformMatrix4(uint32_t program, const char* name, const glm::mat4& m)
	{
		const GLint location = glGetUniformLocation(program, name);
		if (location != -1)
		{
